...
public enum XBRLElement implements Serializable {
	...
	NUMBER_OF_EMPLOYEES(MIX, "NumberOfEmployees", INTEGER, INSTANT, GENERAL),
	NUMBER_OF_OFFICES(MIX, "NumberOfOffices", INTEGER, INSTANT, GENERAL),
	NUMBER_OF_SERVICE_POINTS (MIX, "NumberOfServicePoints", INTEGER, INSTANT, GENERAL),
	COUNTRY_OF_INCORPORATION(IFRS, "CountryOfIncorporation", STRING, INSTANT, GENERAL),
	LEGAL_FORM_OF_ENTITY (IFRS, "LegalFormOfEntity", STRING, INSTANT, GENERAL),
	DESCRIPTION_OF_NATURE_OF_ENTITYS_OPERATIONS_AND_PRINCIPAL_ACTIVITIES (IFRS, "DescriptionOfNatureOfEntitysOperationsAndPrincipalActivities", STRING, INSTANT, GENERAL),
	DESCRIPTION_OF_PRESENTATION_CURRENCY(IFRS, "DescriptionOfPresentationCurrency", STRING, DURATION, GENERAL),
	STATEMENT_OF_IFRS_COMPLIANCE(IFRS, "StatementOfIFRSCompliance", STRING, INSTANT, GENERAL),
	DATE_ENTITY_ESTABLISHED (MIX, "DateEntityEstablished", STRING, INSTANT, GENERAL),
	DATE_OF_END_OF_REPORTING_PERIOD (MIX, "DateOfEndOfReportingPeriod", STRING, INSTANT, GENERAL),
	INSTITUTION_USES_INFLATION_ADJUSTMENTS (MIX, "InstitutionUsesInflationAdjustments", STRING, INSTANT, GENERAL),
	ADDRESS_OF_REGISTERED_OFFICE_OF_ENTITY (MIX, "AddressOfRegisteredOfficeOfEntity", STRING, INSTANT, GENERAL),
	DISCLOSURE_OF_ALLOWANCE_ACCOUNT_FOR_CREDIT_LOSSES_EXPLANATORY (IFRS, "DisclosureOfAllowanceAccountForCreditLossesExplanatory", STRING, INSTANT, GENERAL),
	DISCLOSURE_OF_SUMMARY_OF_SIGNIFICANT_ACCOUNTING_POLICIES_EXPLANATORY (IFRS, "DisclosureOfSummaryOfSignificantAccountingPoliciesExplanatory", STRING, INSTANT, GENERAL),
	OTHER_EXPLANATORY_DISCLOSURE_EXPLANATORY (IFRS, "OtherExplanatoryDisclosureExplanatory", STRING, INSTANT, GENERAL),
